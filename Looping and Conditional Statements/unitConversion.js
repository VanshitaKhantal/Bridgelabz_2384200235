...
rl.question("\nEnter the conversion type (1-4): ", function(choice) {
    rl.question("Enter the value to convert: ", function(value) {
        let convertedValue;
        value = parseFloat(value); // Convert input to number
        
        // Perform unit conversion
        switch (parseInt(choice)) {
            case 1:
                convertedValue = value * 12; // 1 ft = 12 inches
                console.log(`${value} Feet = ${convertedValue} Inches`);
                break;
            case 2:
                convertedValue = value * 0.3048; // 1 ft = 0.3048 meters
            ...
            case 3:
                ...
                break;
            case 4:
                convertedValue = value / 0.3048; // 1 meter = 3.28084 feet
