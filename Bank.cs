...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        Customer customer1 = new Customer("Vanshita");
        Customer customer2 = new Customer("Simran");
        Customer customer3 = new Customer("Misti");

        bank1.OpenAccount(customer1, "Saving", "2000");
        bank1.OpenAccount(customer3, "Current", "3000");
        bank2.OpenAccount(customer1, "Current", "5000");
        bank1.OpenAccount(customer2, "Current", "4000");
        bank3.OpenAccount(customer3, "Saving", "1000");
