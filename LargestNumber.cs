...
public class LargestNumber
{
    ...
    public static void Main(String[] args)
    {
        ...
        string firstResult = IsFirstNumberLargest(number1, number2, number3) ? "Yes" : "No";
	  string secondResult = IsSecondNumberLargest(number1, number2, number3) ? "Yes" : "No";
	  string thirdResult = IsThirdNumberLargest(number1, number2, number3) ? "Yes" : "No";
