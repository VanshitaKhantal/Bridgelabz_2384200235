...
class Program
{
    static void Main()
    {
        ...
        BankAccount account1 = new BankAccount("123456789", "Vanshita Khantal", 5000000);
        ...
        SavingsAccount savingsAccount1 = new SavingsAccount("987654321", "Simran Khantal", 1000000);
