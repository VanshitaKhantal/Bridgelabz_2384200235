...
public class Program
{
    public static void Main(String[] args)
    {
        ...
        Employee employee = new Employee("Vanshita", 100, 80000);
        Employee manager = new Manager("Simran", 101, 60000, 5);
        Employee developer = new Developer("Misti", 102, 40000, "Java");
        Employee intern = new Intern("Muskan", 103, 20000, "Six Months");
