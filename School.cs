...
class Program
{
    ...
    {
        // Create a School
        School school = new School("Sacred Heart Convent School");

        // Create Students
        Student student1 = new Student("Vanshita");
        Student student2 = new Student("Misti");
        Student student3 = new Student("Simran");
